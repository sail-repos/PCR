...
import instrumentor.icb.FireEventsClassTransformer;
import instrumentor.icb.JUCEventsClassTransformer;
import instrumentor.icb.SharedAccessEventsClassTransformer;
import instrumentor.icb.ThreadEventsClassTransformer;
import instrumentor.mcr.ClassAdapter;
...
public class Instrumentor {
    ...
    public static final String logClass = "scheduler/runtime/RVRunTime";
    ...
    static {
        INSTR_EVENTS_RECEIVER = "scheduler.reex.Scheduler".replace(DOT, SLASH);
        packagesThatWereInstrumented = new HashSet<String>();
        packagesThatWereNOTInstrumented = new HashSet<String>();
    }

    private static final String MCR_STRATEGY = "scheduler.scheduling.strategy.MCRStrategy";
    ...
    public static void premain(String agentArgs, Instrumentation inst) {
        ...
        /**
         * for COVCON, set targetClass
         */
        if (agentArgs != null && !agentArgs.equals("AGENTARGS")){

            TargetClassInfo.setUseCovCon(true);
            TargetClassInfo.setTargetClass(agentArgs);
        }
